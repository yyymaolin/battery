...
export const asyncRoutes = [
  ...
  // 系统监控
  {
    ...
    children: [
      ...
      //   name: 'monitor-users',
      //   meta: { permissions: ['admin', 'monitor-users'], title: '锂电池基础数据', icon: 'Steve-Jobs', noCache: true }
      // },
      {
        path: 'recycle',
        component: () => import('@/views/monitor/recycle'),
        name: 'monitor-recycle',
        meta: { permissions: ['admin', 'monitor-recycle'], title: '回收', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'disassemble',
        component: () => import('@/views/monitor/disassemble'),
        name: 'monitor-disassemble',
        meta: { permissions: ['admin', 'monitor-disassemble'], title: '拆解', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'disassemblestatistical',
        component: () => import('@/views/monitor/disassemblestatistical'),
        name: 'monitor-disassemblestatistical',
        meta: { permissions: ['admin', 'monitor-disassemblestatistical'], title: '拆解系统运行', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'powerstation',
        component: () => import('@/views/monitor/powerstation'),
        name: 'monitor-powerstation',
        meta: { permissions: ['admin', 'monitor-powerstation'], title: '储能电站配置', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'running',
        component: () => import('@/views/monitor/running'),
        name: 'monitor-running',
        meta: { permissions: ['admin', 'monitor-running'], title: '电站实时运行', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'price',
        component: () => import('@/views/monitor/price'),
        name: 'monitor-price',
        meta: { permissions: ['admin', 'monitor-price'], title: '所在地电价', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'deal',
        component: () => import('@/views/monitor/deal'),
        name: 'monitor-deal',
        meta: { permissions: ['admin', 'monitor-deal'], title: '外部交易', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'peakregulation',
        component: () => import('@/views/monitor/peakregulation'),
        name: 'monitor-peakregulation',
        meta: { permissions: ['admin', 'monitor-peakregulation'], title: '峰谷套利效益', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'frequencyregulation',
        component: () => import('@/views/monitor/frequencyregulation'),
        name: 'monitor-frequencyregulation',
        meta: { permissions: ['admin', 'monitor-frequencyregulation'], title: '调频效益', icon: 'Steve-Jobs', noCache: true }
      },
      {
        path: 'ip',
